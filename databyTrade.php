    ...
    <body>
        <div class="container">
            <div class="clearfix top_section data_table">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <form method="post" action="searchBytrade.php">
                            <div class="data-name text-right clearfix form-group">
                                <input type="text" name="search" class="form-control bdr" placeholder="Type Company Name for Search" id="ctradeSearch" data-provde="typeahead">
                                <div style="color: white;display:inline-block;vertical-align:top;" class="">
                                    <div class="dropdown bdr">
                                        <button class="btn btn-default dropdown-toggle" type="button" id="menu1" data-toggle="dropdown"><span class="sbt">Trade</span>
